...
(function () {
    ...
    var app = angular.module('dynamicFormsFrameworkAdmin');
         ...
         */
        app.controller('PreviewCtrl', ['$scope','$http','$location','$window','$rootScope',
                                        '$captcha', 'FormService', 'VersionService',
                function ($scope, $http, $location, $window, $rootScope, $captcha,
                            FormService, VersionService) {
        ...
        visor.load = function(){
            FormService.get({id:visor.formIdParam}, function(form){
                delete form.$promise;
                delete form.$resolved;
                visor.title = form.title;
                // Load version
                VersionService.get({formId: visor.formIdParam, versionId: visor.versionIdParam},
                    function(version){
