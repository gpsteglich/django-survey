...
urlpatterns = patterns('dynamicForms.views',
    ...
    url(r'^main/(?P<order>(id|owner|title|creation_date))/(?P<ad>(asc|dsc))/$', 'ordered_forms'),
    ...
    url(r'^editor$', login_required(views.TemplateView.as_view(template_name='editor.html')), name="editor_new"),
