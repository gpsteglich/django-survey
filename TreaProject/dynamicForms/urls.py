...
urlpatterns = patterns('dynamicForms.views',
    ...
    url(r'^checkbox$', views.TemplateView.as_view(template_name='field_checkbox.html')),
    ...
    url(r'^visor/(?P<slug>[a-z,0-9,\-,\_]+)/checkbox$', views.TemplateView.as_view(template_name='field_checkbox.html')),
